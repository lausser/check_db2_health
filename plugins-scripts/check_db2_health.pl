...
my @modes = (
  ...
  ['server::instance::database::applusage',
      'application-usage', undef,
      'Percent of max possible aplications running' ],
  ['server::sql',
      'sql', undef,
  ...
  ['server::instance::database::tablespace::usage::dms::manual',
      'dms-tablespace-usage', undef,
      'Used space at the tablespace level (only manual DMS)' ],
  ['server::instance::database::tablespace::free::dms::manual',
      'dms-tablespace-free', undef,
      'Free space at the tablespace level (only manual DMS)' ],
  ['server::instance::database::tablespace::settings::dms',
      'dms-tablespace-settings', undef,
      'Check the consistency of tablespace-settings (DMS)' ],
  ...
  ['server::instance::database::invalidobjects',
      'invalid-objects', undef,
      'Number of invalid objects in database' ],
  ['server::instance::database::duppackages',
      'duplicate-packages', undef,
      'Find packages names which exist more than one time' ],
